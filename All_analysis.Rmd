...
```{r}
export_summs(S5_rq3_1, S5_rq3_2, S5_rq3_3, S5_rq3_4, S5_rq3_5, S5_rq3_6, robust = c("HC1", "HC1", "HC1", "HC1", "HC1", "HC1"), 
             model.names = c("Sharing (HI)", "Sharing (LI)", "Actual Consumption (HI)", "Actual Consumption (LI)", "Consume (HI)", "Consume (LI)"), digits = 4,
             statistics = (R2adj = "adj.r.squared"),
             coefs = c("Intercept" = "(Intercept)", "Usually Read Detective Fiction" = "scale(as.numeric(pre_test))")) %>% set_caption("Study 5: Outcomes as a function of the frequency of reading detective fiction for High (HI) and Low Insight Stimuli (LI)")
```
