...
author: "Marius Mercier, Alexis Garsmeur, Hugo Mercier"
date: "2023-11-01"
output:
  pdf_document:
...
\newpage
The Electronic Supplementary Material include more information on the Ethnographical Review (section 1), provide pre-registered analysis not presented in the paper for concision (section 2), and provide all the regression table of the analysis presented in the paper both with and without controls (section 3). We also include more information on exploratory analysis presented in the discussion (section 4). Materials not presented in the paper are available in section 5. This pdf file is generated using the RMarkdown file "All_analysis.Rmd". All scripts used for the data processing, the statistical analysis and for creating the figure can be found following this Github link: <https://github.com/mariusmercier/paper_insight_culture>. Simply copy the github and run the Rmd file. A permanent archive is also available at the following OSF project: <https://osf.io/7qwt2/>.
...
export_summs(S1_h13_1, S1_h13_2, robust = c("HC1", "HC1"),
             ...
             statistics = c(N = "nobs", AIC = "AIC", BIC = "BIC")) %>% set_caption("Study 1: Willingness to share as a function of Insight within each condition")
```
...
export_summs(S2_h13_1, S2_h13_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share High Insight Condition", "Will. to Share Low Insight Condition"), digits = 4,
             statistics = c(N = "nobs", AIC = "AIC", BIC = "BIC")) %>% set_caption("Study 2: Willingness to share as a function of Insight, within each condition")
...
export_summs(S3_h13_1, S3_h13_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share High Insight Condition", "Will. to Share Low Insight Condition"), digits = 4,
             statistics = c(N = "nobs", AIC = "AIC", BIC = "BIC")) %>% set_caption("Study 3: Willingness to share as a function of insight, within each condition")
```
...
export_summs(S3_h33_1, S3_h33_2, robust = c("HC1", "HC1"), 
             ...
             statistics = c(N = "nobs", AIC = "AIC", BIC = "BIC")) %>% set_caption("Study 3: Willingness to Consume as a function of insight, within each condition")
```
...
export_summs(S1_h11_1, S1_h11_2, S1_h11_3, robust = c("HC1", "HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 1: Willingness to Share as a function of condition, with and without controls")
```
...
export_summs(S1_h12_1, S1_h12_2, S1_h12_3, robust = c("HC1", "HC1", "HC1"), 
             model.names = c("Will. to Share", "Will. to share", "Will. to share"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 1: Willingness to Share as a function of insight, with and without controls")
```
...
export_summs(S1_h21_1, S1_h21_2, S1_h21_3, robust = c("HC1", "HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 1: Actual Consumption as a function of condition, with and without controls")
```
...
export_summs(S1_h22_1, S1_h22_2, S1_h22_3, robust = c("HC1", "HC1", "HC1"), 
             model.names = c("Actual Consumption", "Actual Consumption", "Actual Consumption"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 1: Actual Consumption as a function of insight, with and without controls")
```
...
export_summs(S2_h11_1, S2_h11_2, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 2: Willingness to share as a function of condition, with and without controls")
```
...
export_summs(S2_h12_1, S2_h12_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share", "Will. to share"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 2: Willingness to share as a function of insight, with and without controls")
```
...
export_summs(S2_h21_1, S2_h21_2, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 2: Actual consumption as a function of condition, with and without controls")
```
...
export_summs(S2_h22_1, S2_h22_2, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption", "Actual Consumption"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 2: Actual consumption as a function of insight, with and without controls")
```
...
export_summs(S3_h11_1, S3_h11_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share", "Will. to share"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Willingness to share as a function of condition, with and without controls")
```
...
export_summs(S3_h12_1, S3_h12_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share", "Will. to share"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Willingness to share as a function of insight, with and without controls")
```
...
export_summs(S3_h21_1, S3_h21_2, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption", "Actual Consumption"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Actual consumption as a function of condition, with and without controls")
```
...
export_summs(S3_h22_1, S3_h22_2, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption", "Actual Consumption"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Actual consumption as a function of insight, with and without controls")
```
...
export_summs(S3_h31_1, S3_h31_2, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Willingness to consume as a function of condition, with and without controls")
```
...
export_summs(S3_h32_1, S3_h32_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Consume", "Will. to Consume"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Willingness to consume as a function of insight, with and without controls")
```
...
export_summs(S4_h11_1, S4_h11_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share", "Will. to share"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 4: Willingness to share as a function of condition, with and without controls")
```
...
export_summs(S4_h12_1, S4_h12_2, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 4: Willingness to share as a function of insight, with and without controls, within the High Insight Condition")
```
...
export_summs(S4_h12_3, S4_h12_4, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 4: Willingness to share as a function of insight, with and without controls, within the Low Insight Condition")
```
...
export_summs(S4_h21_1, S4_h21_2, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption", "Actual Consumption"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 4: Actual consumption as a function of condition, with and without controls")
```
...
export_summs(S4_h22_1, S4_h22_2, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 4: Actual consumption as a function of insight, with and without controls, within the High Insight Condition")
```
...
export_summs(S4_h22_3, S4_h22_4, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 4: Actual consumption as a function of insight, with and without controls, within the Low Insight Condition")
```
...
export_summs(S5_h11_1, S5_h11_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share", "Will. to share"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Willingness to share as a function of condition, with and without controls")
```
...
export_summs(S5_h12_1, S5_h12_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share (HI Condition)", "Will. to share (HI Condition)"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Willingness to share as a function of insight, with and without controls, within the High Insight Condition")
```
...
export_summs(S5_h12_3, S5_h12_4, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Share (LI Condition)", "Will. to share (LI Condition)"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Willingness to share as a function of insight, with and without controls, within the Low Insight Condition")
```
...
export_summs(S5_h21_1, S5_h21_2, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption", "Actual Consumption"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Actual consumption as a function of condition, with and without controls")
```
...
export_summs(S5_h22_1, S5_h22_2, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption (HI Condition)", "Actual Consumption (HI Condition)"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Actual consumption as a function of insight, with and without controls, within the High Insight Condition")
```
...
export_summs(S5_h22_3, S5_h22_4, robust = c("HC1", "HC1"), 
             model.names = c("Actual Consumption (LI Condition)", "Actual Consumption (LI Condition)"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Actual consumption as a function of insight, with and without controls, within the Low Insight Condition")
...
export_summs(S5_h31_1, S5_h31_2, robust = c("HC1", "HC1"), 
             model.names = c("Will. to Consume", "Will. to Consume"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Willingness to consume as a function of condition, with and without controls")
```
...
export_summs(S5_h32_1, S5_h32_2, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Willingness to consume as a function of insight, with and without controls, within the High Insight Condition")
```
...
export_summs(S5_h32_3, S5_h32_4, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 5: Willingness to consume as a function of insight, with and without controls, within the Low Insight Condition")
```
...
ggplot(data = combined_data, aes(x = estimate_scaled, y = study)) +
  geom_point(aes(y = as.numeric(study) + Offset, shape = condition, color = Significance), size = 2) +
  ...
  scale_shape_manual(values = c("High Insight" = 16, "Low Insight" = 17, "Overall" = 15)) +
  scale_y_continuous(breaks = seq(1, length(unique(combined_data$study))), labels = levels(combined_data$study)) +
  scale_color_manual(values = c("Significant" = "green", "Non-significant" = "red")) +
  theme_bw()
...
export_summs(S3_rq1, S5_rq1, robust = c("HC1", "HC1"), 
             ...
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Actual Consumption as a function of willingness to consume")
```
\FloatBarrier
**RQ2**: Does finding the solution by oneself has an influence on the intensity of insight?

```{r echo = TRUE}
S1_rq2_1 = lmer(scale(insight) ~ factor(solved) + (1| stumpers) + (1 + factor(solved) | ResponseId), data = data_High1)
S1_rq2_2 = lmer(scale(insight) ~ factor(solved) + (1| stumpers) + (1 + factor(solved) | ResponseId), data = data_Low1)

S2_rq2_1 = lmer(scale(insight) ~ factor(solved) + (1| stumpers) + (1 + factor(solved) | ResponseId), data = data_High2)
S2_rq2_2 = lmer(scale(insight) ~ factor(solved) + (1| stumpers) + (1 + factor(solved) | ResponseId), data = data_Low2)

S3_rq2_1 = lmer(scale(insight) ~ factor(solved) + (1| stumpers) + (1 + factor(solved) | ResponseId), data = data_High3)
S3_rq2_2 = lmer(scale(insight) ~ factor(solved) + (1| stumpers) + (1 + factor(solved) | ResponseId), data = data_Low3)
```

```{r}
export_summs(S1_rq2_1, S1_rq2_2, robust = c("HC1", "HC1"), 
             model.names = c("Insight (HI Condition) S1", "Insight (LI Condition) S1"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 1: Insight as a function of finding the solution by oneself")
```

```{r}
export_summs(S2_rq2_1, S2_rq2_2, robust = c("HC1", "HC1"), 
             model.names = c("Insight (HI Condition) S2", "Insight (LI Condition) S2"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 2: Insight as a function of finding the solution by oneself")
```

```{r}
export_summs(S3_rq2_1, S3_rq2_2, robust = c("HC1", "HC1"), 
             model.names = c("Insight (HI Condition) S3", "Insight (LI Condition) S3"), digits = 4,
             statistics = (R2adj = "adj.r.squared")) %>% set_caption("Study 3: Insight as a function of finding the solution by oneself")
```
...
# 5. Materials for whodunits studies
